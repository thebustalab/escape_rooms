...
- **The 16-cell claim is real.** `notes/report.md:50` — "The four `heist` rooms animate in **all 16 cells** of their grids"; line 65 names `compare_cal_a_gallery.mp4` (dust sheet) among the alive positive controls.
